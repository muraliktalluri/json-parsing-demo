...
schema_hint = prime_schema['primeSchemahint']

# COMMAND ----------

@dlt.table(name=topic_name + '_primed_schema')
def read_from_kafka():
  return (spark.readStream.format("kafka")
    ...
    .load()
    .withColumn("value_parsed", from_json(col("value").cast('string'), None, {"schemaLocationKey": topic_name, 'schemaHints' : schema_hint}))
    .selectExpr(
      'topic',
      'partition',
      'offset',
